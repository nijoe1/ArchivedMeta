...
contract MarketAPI {
    ...
    mapping(uint256 => MarketTypes.MockDeal) deals;
   ...
   /// @return the client of a deal proposal.
    ...
    function publish_storage_deal(MarketTypes.MockDeal memory deal, address callee) public {
    ...
    function getDeal() public view returns (MarketTypes.MockDeal memory deal){
        return deals[0];
    }

    function createDeal(uint256 dealID,address client )public returns(MarketTypes.MockDeal memory deal) {
        deal.id = dealID;
        deal.cid = "baga6ea4seaqlkg6mss5qs56jqtajg5ycrhpkj2b66cgdkukf2qjmmzz6ayksuci";
        deal.size = 8388608;
        deal.verified = false;
        deal.client = client;
        deal.provider = 0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB;
